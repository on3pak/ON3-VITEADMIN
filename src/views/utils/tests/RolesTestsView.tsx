    ...
    <div className="space-y-6">
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-bold text-slate-800">Tests de Roles y Permisos</h3>
            <p className="text-xs text-slate-400 mt-1">Validación de acceso por rol y matriz de permisos</p>
          </div>
          <button
            onClick={runAllTests}
