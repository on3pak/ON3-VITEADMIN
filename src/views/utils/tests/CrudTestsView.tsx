...
export const CrudTestsView: React.FC = () => {
  const [isRunningAll, setIsRunningAll] = useState(false);
  const [testSuite, setTestSuite] = useState<MockTest[]>([
    {
      id: 'T-04',
      name: 'CRUD: Creación e inserción reactiva en base de datos',
      category: 'USER_CRUD',
      description: 'Verifica que al agregar un nuevo registro a través del formulario, el contador incremente de forma segura.',
      status: 'IDLE',
      assertions: [
        'La inserción no colisiona con nombres de usuario repetidos',
        'El registro recibe un ID aleatorio único con prefijo "usr-"',
        'La longitud de la lista mutada en el state incrementa en 1'
      ]
    }
  ]);
