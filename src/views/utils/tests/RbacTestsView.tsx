    ...
    <div className="space-y-6">
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-bold text-app-text">Tests de RBAC</h3>
            <p className="text-xs text-app-text-secondary mt-1">Controles de acceso basados en roles y restricciones de seguridad</p>
          </div>
          <button
            onClick={runAllTests}
