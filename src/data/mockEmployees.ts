...
const EMPLOYEES_SEED: Omit<Employee, 'id'>[] = [
  {
    city_id: 'city_1', name: 'Miguel Ángel', lastName1: 'Torres', lastName2: 'García',
    email: '000001@on3.com', phone: '612345678', category_id: 'ec_1', status_id: 'es_1', work_center_id: 'wc_1',
  ...
  {
    city_id: 'city_1', name: 'Alejandro', lastName1: 'Mendoza', lastName2: '',
    email: '000002@on3.com', phone: '612345679', category_id: 'ec_2', status_id: 'es_1', work_center_id: 'wc_2',
  ...
  {
    city_id: 'city_1', name: 'Beatriz', lastName1: 'Salazar', lastName2: '',
    email: '000003@on3.com', phone: '612345680', category_id: 'ec_3', status_id: 'es_2', work_center_id: 'wc_3',
    active: true, shift_id: 's_1', start_time: '08:00', end_time: '16:00',
  ...
  {
    city_id: 'city_1', name: 'Carlos', lastName1: 'Fuentes', lastName2: '',
    email: '000004@on3.com', phone: '612345681', category_id: 'ec_4', status_id: 'es_1', work_center_id: 'wc_4',
  ...
  {
    city_id: 'city_2', name: 'Pedro', lastName1: 'Hernández', lastName2: 'Díaz',
    email: '000005@on3.com', phone: '612345682', category_id: 'ec_5', status_id: 'es_3', work_center_id: 'wc_5',
  ...
  {
    city_id: 'city_1', name: 'Laura', lastName1: 'Jiménez', lastName2: 'Ruiz',
    email: '000006@on3.com', phone: '612345683', category_id: 'ec_6', status_id: 'es_1', work_center_id: 'wc_7',
    active: true, shift_id: 's_2', start_time: '14:00', end_time: '22:00',
    vacation_month: 'SEPTEMBER', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_2', name: 'Miguel', lastName1: 'Torres', lastName2: 'Navarro',
    email: '000007@on3.com', phone: '612345684', category_id: 'ec_7', status_id: 'es_4', work_center_id: 'wc_6',
    active: true, shift_id: 's_1', start_time: '08:00', end_time: '16:00',
    vacation_month: 'JULY', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_1', name: 'Carmen', lastName1: 'Morales', lastName2: 'Serrano',
    email: '000008@on3.com', phone: '612345685', category_id: 'ec_8', status_id: 'es_1', work_center_id: 'wc_8',
  ...
  {
    city_id: 'city_2', name: 'Javier', lastName1: 'Ramos', lastName2: 'Castro',
    email: '000009@on3.com', phone: '612345686', category_id: 'ec_9', status_id: 'es_5', work_center_id: 'wc_1',
    active: true, shift_id: 's_2', start_time: '14:00', end_time: '22:00',
    vacation_month: 'SEPTEMBER', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_1', name: 'Sofia', lastName1: 'Vega', lastName2: 'Ortega',
    email: '000011@on3.com', phone: '612345687', category_id: 'ec_10', status_id: 'es_1', work_center_id: 'wc_8',
    active: true, shift_id: 's_1', start_time: '09:00', end_time: '17:00',
    vacation_month: 'JULY', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_2', name: 'Antonio', lastName1: 'Molina', lastName2: 'Delgado',
    email: '000012@on3.com', phone: '612345688', category_id: 'ec_1', status_id: 'es_6', work_center_id: 'wc_2',
    active: true, shift_id: 's_3', start_time: '22:00', end_time: '06:00',
    vacation_month: 'AUGUST', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_1', name: 'Isabel', lastName1: 'Romero', lastName2: 'Aguilar',
    email: '000013@on3.com', phone: '612345689', category_id: 'ec_2', status_id: 'es_1', work_center_id: 'wc_3',
    active: true, shift_id: 's_1', start_time: '08:00', end_time: '16:00',
    vacation_month: 'SEPTEMBER', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_2', name: 'David', lastName1: 'Cortés', lastName2: 'Garrido',
    email: '000014@on3.com', phone: '612345690', category_id: 'ec_3', status_id: 'es_1', work_center_id: 'wc_4',
    active: true, shift_id: 's_2', start_time: '14:00', end_time: '22:00',
    vacation_month: 'JULY', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_1', name: 'Elena', lastName1: 'Soto', lastName2: 'Pérez',
    email: '000015@on3.com', phone: '612345691', category_id: 'ec_4', status_id: 'es_2', work_center_id: 'wc_5',
    active: true, shift_id: 's_1', start_time: '08:00', end_time: '16:00',
    vacation_month: 'AUGUST', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_2', name: 'Francisco', lastName1: 'Ruiz', lastName2: 'Guerrero',
    email: '000016@on3.com', phone: '612345692', category_id: 'ec_5', status_id: 'es_1', work_center_id: 'wc_7',
    active: true, shift_id: 's_2', start_time: '14:00', end_time: '22:00',
    vacation_month: 'SEPTEMBER', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_1', name: 'Patricia', lastName1: 'Flores', lastName2: 'Moreno',
    email: '000017@on3.com', phone: '612345693', category_id: 'ec_6', status_id: 'es_1', work_center_id: 'wc_7',
    active: true, shift_id: 's_1', start_time: '08:00', end_time: '16:00',
    vacation_month: 'JULY', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_2', name: 'Roberto', lastName1: 'Gil', lastName2: 'Santos',
    email: '000018@on3.com', phone: '612345694', category_id: 'ec_7', status_id: 'es_3', work_center_id: 'wc_6',
  ...
  {
    city_id: 'city_1', name: 'Sandra', lastName1: 'Núñez', lastName2: 'Herrera',
    email: '000019@on3.com', phone: '612345695', category_id: 'ec_8', status_id: 'es_1', work_center_id: 'wc_8',
    active: true, shift_id: 's_1', start_time: '09:00', end_time: '17:00',
    vacation_month: 'SEPTEMBER', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_2', name: 'Alberto', lastName1: 'Castillo', lastName2: 'Jiménez',
    email: '000020@on3.com', phone: '612345696', category_id: 'ec_9', status_id: 'es_1', work_center_id: 'wc_1',
    active: true, shift_id: 's_2', start_time: '14:00', end_time: '22:00',
    vacation_month: 'JULY', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
  ...
  {
    city_id: 'city_1', name: 'Natalia', lastName1: 'Domínguez', lastName2: 'Vargas',
    email: '000021@on3.com', phone: '612345697', category_id: 'ec_10', status_id: 'es_4', work_center_id: 'wc_8',
    active: true, shift_id: 's_1', start_time: '09:00', end_time: '17:00',
    vacation_month: 'AUGUST', vacation_year: 2024, vacation_days: 22, own_days: 2, accumulated_days: 5, excess_days: 0,
