...
| ID entidades dinámicas | Prefijados con secuencia (`wc_1`, `veh_001`, `svc_1`, `inv_001`, `st_1`, `vr_1`) |
| ID lookup tables | IDs explícitos sin secuencia (`city_1`, `ec_1`, `wd_1`, `vt_1`, `ist_1`, `is_1`) |
| Email users y employees | `{employee_id}@on3.com` — ej: `000001@on3.com` |
| Link user → employee | `users.employee_id` FK → `employees.id` (inversión respecto a mocks actuales) |
...
CREATE TYPE vacation_month AS ENUM ('JULY', 'AUGUST', 'SEPTEMBER', 'SPLIT');
...
> **Nota**: Los valores enum están en inglés. El frontend actual usa español (`'ropa'`, `'epi'`, `'maquinaria'`, `'ACTIVO'`, `'GASOLINA'`, `'julio'`). Los tipos TypeScript deben actualizarse para reflejar los valores de la DB.
...
Lookup table. IDs explícitos, sin secuencia (solo 2 registros, estáticos).
...
Lookup table. `category` es el tipo de vehículo (BARREDORA, CAMION, etc.); `name` es el nombre comercial.
...
Tabla dinámica. Usa secuencia para auto-generar IDs.
...
INSERT INTO work_centers (id, name, address, city_id, status, created_at, updated_at) VALUES
  ...
  ('wc_3',  'Gilitos',       'Polígono Gilitos 8',       'city_1', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ...
  ('wc_7',  'Taller',        'Polígono Industrial 12',   'city_1', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_8',  'Oficinas',      'Calle Administración 1',   'city_1', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_9',  'Almacén',       'Av. Logística 55',         'city_1', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_11', 'Centro01',      'Av. Henares 100',          'city_2', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_12', 'Centro02',      'Calle Innovación 5',       'city_2', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_13', 'Centro03',      'Polígono Industrial 3',    'city_2', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_14', 'Centro04',      'Av. Estación 12',          'city_2', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_15', 'Centro05',      'Plaza Mayor 1',            'city_2', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_16', 'Centro06',      'Paseo Estación 45',        'city_2', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ...
  ('wc_20', 'Centro10',      'Calle Clavín 17',          'city_2', 'INACTIVE', '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z'),
  ('wc_21', 'Almacén Sur',   'Polígono Industrial Sur 1','city_2', 'ACTIVE',  '2024-01-01T00:00:00Z', '2024-01-01T00:00:00Z');
...
INSERT INTO employees (id, city_id, name, last_name1, last_name2, email, phone, personal_email, phone_fixed, category_id, status_id, work_center_id, active, shift_id, start_time, end_time, work_day_id, contract_type, contract_start_date, contract_end_date, irpf, vacation_month, vacation_year, vacation_days, own_days, accumulated_days, excess_days, iban, locker, medical_check, works_holidays, created_at, updated_at) VALUES
  ('000001', 'city_1', 'Miguel Ángel', 'Torres', 'García', '000001@on3.com', '612345678', 'm.torres@gmail.com', '918765432', 'ec_1', 'es_1', 'wc_1', true, 's_1', '08:00', '16:00', 'wd_1', 'ct_1', '2023-06-01', NULL, 15, 'JULY', 2024, 22, 2, 5, 0, 'ES7620770024003102571234', 'L-001', true, true, '2024-01-15T08:00:00Z', '2024-01-15T08:00:00Z'),
  ...
  ('000005', 'city_2', 'Pedro', 'Hernández', 'Díaz', '000005@on3.com', '612345682', 'pedro.hernandez@gmail.com', '918765436', 'ec_5', 'es_3', 'wc_5', false, 's_1', '08:00', '16:00', 'wd_1', 'ct_1', '2022-05-20', NULL, 16, 'AUGUST', 2024, 22, 2, 5, 0, 'ES7620770024003102571238', 'L-005', false, false, '2023-11-08T08:00:00Z', '2024-05-15T08:00:00Z'),
  ('000006', 'city_1', 'Laura', 'Jiménez', 'Ruiz', '000006@on3.com', '612345683', 'laura.jimenez@gmail.com', '918765437', 'ec_6', 'es_1', 'wc_7', true, 's_2', '14:00', '22:00', 'wd_1', 'ct_1', '2023-03-01', NULL, 17, 'SEPTEMBER', 2024, 22, 2, 5, 0, 'ES7620770024003102571239', 'L-006', true, true, '2023-08-12T09:00:00Z', '2023-08-12T09:00:00Z'),
  ...
  ('000014', 'city_2', 'David', 'Cortés', 'Garrido', '000014@on3.com', '612345690', 'david.cortes@gmail.com', '918765444', 'ec_3', 'es_1', 'wc_4', true, 's_2', '14:00', '22:00', 'wd_1', 'ct_2', '2024-03-01', '2025-03-01', 14, 'JULY', 2024, 22, 2, 5, 0, 'ES7620770024003102571246', 'L-013', true, true, '2024-03-18T08:00:00Z', '2024-03-18T08:00:00Z'),
  ('000015', 'city_1', 'Elena', 'Soto', 'Pérez', '000015@on3.com', '612345691', 'elena.soto@gmail.com', '918765445', 'ec_4', 'es_2', 'wc_5', true, 's_1', '08:00', '16:00', 'wd_2', 'ct_1', '2022-09-01', NULL, 15, 'AUGUST', 2024, 22, 2, 5, 0, 'ES7620770024003102571247', 'L-014', true, false, '2023-10-12T10:00:00Z', '2024-05-20T10:00:00Z'),
  ...
  ('000019', 'city_1', 'Sandra', 'Núñez', 'Herrera', '000019@on3.com', '612345695', 'sandra.nunez@gmail.com', '918765449', 'ec_8', 'es_1', 'wc_8', true, 's_1', '09:00', '17:00', 'wd_1', 'ct_1', '2020-08-01', NULL, 21, 'SEPTEMBER', 2024, 22, 2, 5, 0, 'ES7620770024003102571251', 'L-018', true, true, '2022-11-20T08:00:00Z', '2022-11-20T08:00:00Z'),
  ('000020', 'city_2', 'Alberto', 'Castillo', 'Jiménez', '000020@on3.com', '612345696', 'alberto.castillo@gmail.com', '918765450', 'ec_9', 'es_1', 'wc_1', true, 's_2', '14:00', '22:00', 'wd_1', 'ct_1', '2018-06-01', NULL, 24, 'JULY', 2024, 22, 2, 5, 0, 'ES7620770024003102571252', 'L-019', true, true, '2023-03-08T09:00:00Z', '2023-03-08T09:00:00Z'),
  ('000021', 'city_1', 'Natalia', 'Domínguez', 'Vargas', '000021@on3.com', '612345697', 'natalia.dominguez@gmail.com', '918765451', 'ec_10', 'es_4', 'wc_8', true, 's_1', '09:00', '17:00', 'wd_2', 'ct_1', '2023-04-15', NULL, 14, 'AUGUST', 2024, 22, 2, 5, 0, 'ES7620770024003102571253', 'L-020', true, false, '2024-02-28T08:00:00Z', '2024-06-10T08:00:00Z');
```

> **Nota**: Se corrigieron `personal_email` que no coincidían con el nombre del empleado (copia de datos de otros empleados en el mock original).

---

### 3.12 `users`

ID es UUID v4 generado por el endpoint de creación. `employee_id` invierte la relación respecto a los mocks actuales (antes `employee.user_id` → `users.id`).
...
-- contraseñas en seed: root123, admin123, manager123, user123 (hasheadas por endpoint)
INSERT INTO users (id, employee_id, username, email, full_name, role, status, language, city_id, created_at, updated_at) VALUES
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567801', '000001', 'm.torres',    '000001@on3.com', 'Miguel Ángel Torres',  'ROOT',   'ACTIVE', 'ES', 'city_1', '2025-01-10T08:30:00Z', '2025-01-10T08:30:00Z'),
  ...
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567806', '000006', 'eduardo_gomez','000006@on3.com','Eduardo Gómez',         'USER',   'INACTIVE','ES','city_1', '2025-02-18T16:50:00Z', '2025-02-18T16:50:00Z'),
  ...
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567808', '000008', 'hugo_perez',  '000008@on3.com', 'Hugo Pérez',            'USER',   'ACTIVE', 'ES', 'city_1', '2025-02-20T10:00:00Z', '2025-02-20T10:00:00Z');
```
...
`requested_days` se ha normalizado a una tabla separada `vacation_request_days` (más consultable que un array Postgres).
...
INSERT INTO vehicles (id, license_plate, model, brand, vehicle_type_id, status, vin, registration_date, itv_expiration, insurance_expiration, tax_expiration, fuel_type, kilometers, last_review_date, next_review_kilometers, work_center_id, assigned_employee_id, observations, created_at, updated_at) VALUES
  ...
  ('veh_003', '9012HIJ', 'Transit 350L', 'Ford', 'vt_3', 'MAINTENANCE', 'VIN456789123GHI003', '2023-06-10', '2025-06-10', '2025-06-10', '2025-12-31', 'DIESEL', 28500, '2024-04-20', 40000, 'wc_7', '000003', 'En taller para revisión', '2023-06-10T08:00:00Z', '2024-04-20T08:00:00Z'),
  ...
  ('veh_005', '7890NOP', 'Porter PX', 'Piaggio', 'vt_5', 'BROKEN', 'VIN321654987MNO005', '2023-09-01', '2025-09-01', '2024-09-01', '2025-12-31', 'LPG', 65000, '2024-02-15', 80000, 'wc_7', NULL, 'Avería en motor, pendiente de reparación', '2023-09-01T08:00:00Z', '2024-02-15T08:00:00Z'),
...
INSERT INTO services (id, work_center_id, name, category, created_at, updated_at) VALUES
  ...
  ('svc_3', 'wc_3', 'BMEC3', 'BARRIDO MECÁNICO',  '2024-02-01T08:00:00Z', '2024-06-01T08:00:00Z'),
...
Los atributos específicos de cada categoría (talla, color, certificación, serie, etc.) van en `attributes` (JSONB).
...
> Seed de inventory_items en `src/data/mockInventory.ts` (~840 líneas, 49 items). Se migrará manteniendo la misma estructura.
...
> **Nota sobre tipos**: `employee_overviews.status_id` es FK a `employee_statuses`, y `status_name` es el nombre del estado en español. El tipo `EmployeeOverview` debe tener `status_id` y `status_name`.
...
| Enums idioma | Español (`'ropa'`, `'GASOLINA'`, `'julio'`) | Inglés (`'CLOTHING'`, `'PETROL'`, `'JULY'`) |
...
| Sequence sync | No aplica | `SELECT setval(...)` tras seeds explícitos |
...
SELECT setval('veh_id_seq', (SELECT MAX(CAST(SUBSTRING(id, 5) AS INTEGER)) FROM vehicles));
SELECT setval('svc_id_seq', (SELECT MAX(CAST(SUBSTRING(id, 5) AS INTEGER)) FROM services));
-- NOTA: st_id_seq e inv_id_seq se sincronizan automáticamente si se usa NEXT VALUE en los seeds
```
...
- [ ] Actualizar `src/types/inventory.ts`: `InventoryCategory` → `'CLOTHING' | 'PPE' | 'MACHINERY'`
- [ ] Actualizar `src/types/vehicle.ts`: `VehicleStatus`, `FuelType` → valores ingleses
- [ ] Actualizar `src/types/employee.ts`: `VacationMonth`, `VacationRequest.type/status` → valores ingleses
- [ ] Actualizar `src/types/employee.ts`: `Employee.status` → `status_id: string` (FK a lookup table `employee_statuses`)
- [ ] Actualizar `src/types/employee.ts`: `Employee.shift` → `shift_id: string` (FK a lookup table `shifts`)
- [ ] Actualizar `src/types/employee.ts`: `Employee.contract_type` → `contract_type: string` (FK a lookup table `contract_types`)
- [ ] Actualizar `src/types/employee.ts`: `Employee.work_day` → `work_day_id`
- [ ] Eliminar `schedule` de `Employee` (computar de `start_time` + `end_time`)
- [ ] Actualizar `src/types/employee.ts`: inversión relación user (eliminar `user_id`, agregar `employee_id` en User)
- [ ] Actualizar `src/types/employee.ts`: `EmployeeOverview` → agregar `status_name: string`
- [ ] Actualizar src/data/mock*.ts: todos los IDs con guiones → guiones bajos
- [ ] Actualizar src/data/mock*.ts: IDs de ciudades, categorías, etc.
